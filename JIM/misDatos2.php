					...
					<div id="content">
						<div id="box1">
							<h2>
                                                        <?php 
                                                        $bd = new conexionBD();
                                                        $bd->sentencia = "select nombre from colaboradores where id_colaborador=".$_SESSION["User_id"].";";
                                                        $rs = $bd->Consultar();
							...
							<p>
							<table>
                                                        <form action="updateDatos.php" method="post"  autocomplete="off">
                                                            <tr><td>Talla: <select name="Talla">
